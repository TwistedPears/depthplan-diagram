...
84 SVGs, including Style controls and the two/three-square child indicators.
...
uses them to validate its 44-icon set plus `square-stack-2` and `square-stack-3`.
